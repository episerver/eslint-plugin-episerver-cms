...
const deprecatedModules = require("../references/base_api_overview.json").deprecated.map(name => name.toLowerCase());
...
module.exports = {
    meta: {
        docs: {
            ...
            recommended: true,
            url: "https://github.com/seriema/eslint-plugin-episerver-cms/blob/master/docs/rules/no-deprecated-episerver-apis.md"
        },
        schema: [
            // fill in your schema
        ]
