...
const publicModules = require("../references/base_api_overview.json").public.map(
...
module.exports = {
    meta: {
        docs: {
            ...
            recommended: true,
            url:
                "https://github.com/seriema/eslint-plugin-episerver-cms/blob/master/docs/rules/no-internal-episerver-apis.md",
        },
        schema: [
            // fill in your schema
        ],
    ...
    create: function(context) {
        ...
        function applyRule(dependency) {
            ...
            const isInternal = publicModules.every(
                allowedDep => dep !== allowedDep
            );
            if (!isInternal) {
                return;
            }
